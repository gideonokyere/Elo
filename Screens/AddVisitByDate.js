...
import {addVisitByDates,listVisitByDates,checkedVisitDone,checkedVisitUndone,deleteVisit,fetchDoneVisit,visitDrop} from '../actions/visitAction';


class AddVisitByDate extends Component{
    ...
    addVisit=()=>{
        ...
        this.props.saveVisit(visit,date);
        this.setState({visit:''});
        this.props.fetchData()
    }
...
const mapStateToProps =state=>{
    return{
        id:state.addVisitByDate,
        visits:state.listVisitByDate,
...
const mapDespatchToProps=despatch=>{
   return{
    saveVisit:(visit,date)=>despatch(addVisitByDates(visit,date)),
    fetchData:()=>despatch(listVisitByDates()),
...
const styles = StyleSheet.create({
  ...
  export default connect(mapStateToProps,mapDespatchToProps)(AddVisitByDate);